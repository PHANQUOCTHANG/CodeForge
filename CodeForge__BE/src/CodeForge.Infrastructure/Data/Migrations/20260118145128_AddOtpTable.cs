...
namespace CodeForge.src.CodeForge.Infrastructure.Data.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReturnType = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CodingProblems", x => x.ProblemID);
                    table.ForeignKey(
                        name: "FK_CodingProblems_Lessons_LessonId",
                        column: x => x.LessonId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LessonTexts", x => x.LessonId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LessonVideos", x => x.LessonId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TestCases_CodingProblems_ProblemId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Answers = table.Column<string>(type: "NVARCHAR(MAX)", nullable: false, defaultValueSql: "N'[]'"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuantityTestPassed = table.Column<int>(type: "int", nullable: true),
                    QuantityTest = table.Column<int>(type: "int", nullable: true),
                    TestCaseIdFail = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Submissions", x => x.SubmissionID);
                    table.ForeignKey(
                        name: "FK_Submissions_CodingProblems_ProblemId",
                        column: x => x.ProblemId,
                        principalTable: "CodingProblems",
                        principalColumn: "ProblemID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Submissions_TestCases_TestCaseIdFail",
                        column: x => x.TestCaseIdFail,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SubmissionResults", x => x.ResultID);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CodingProblems_LessonId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Submissions_TestCaseIdFail",
                table: "Submissions",
                column: "TestCaseIdFail");
