...
import "@/pages/client/practice/practice-detail-page/DetailPractice.scss";
import { useNavigate } from "react-router-dom";
import Loading from "@/common/helper/Loading";

import type { CodingProblem, LessonDto } from "@/features";
...
// Component chính
const CodeContent: React.FC<Props> = ({ lesson }) => {
  const navigate = useNavigate();
  const slug = lesson?.codingProblem?.slug;
